...
This teaching environment uses an unsigned repository on an internal service network. Production deployment would require signed metadata, an approval workflow, and an appropriate network access policy. No sabotage or monitor-evasion recording is provided.
